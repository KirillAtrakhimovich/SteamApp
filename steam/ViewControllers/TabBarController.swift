...
final class TabBarController: UITabBarController {
    ...
    func setupVCs() {
        viewControllers = [
            ...
            createNavController(for: NewsViewController(networkManager: NetworkManager(), persistenceManager: PersistenceManager(), filterTableController: NewsFilterTableController(persist: PersistenceManager()), tableViewCell: NewsFilterTableCell()), title: NSLocalizedString(Constants.newsTitle, comment: Constants.empty), image: Constants.newsIcon)
        ]
    }
